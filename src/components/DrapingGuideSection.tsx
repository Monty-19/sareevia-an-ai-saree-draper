...
import drapingFront from "@/assets/draping-front.jpg";
import drapingRight from "@/assets/draping-right.jpg";
import drapingBack from "@/assets/draping-back.jpg";
import drapingLeft from "@/assets/draping-left.jpg";
...
const viewAngles = [
  { name: "Front View", img: drapingFront },
  { name: "Right Side", img: drapingRight },
  { name: "Back View", img: drapingBack },
  { name: "Left Side", img: drapingLeft },
];
            ...
            <div className="rounded-3xl border border-border bg-card p-8 shadow-soft">
              ...
              <div className="overflow-hidden rounded-2xl bg-secondary/50">
                <AnimatePresence mode="wait">
                  <motion.img
                    key={activeView}
                    src={viewAngles[activeView].img}
                    alt={`Saree draping - ${viewAngles[activeView].name}`}
                    loading="lazy"
                    width={768}
                    height={1024}
              ...
              <div className="mt-4 text-center">
                ...
                <p className="mt-1 text-sm text-muted-foreground">{viewAngles[activeView].name}</p>
              </div>
